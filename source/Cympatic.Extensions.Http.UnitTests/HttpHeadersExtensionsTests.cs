...
namespace Cympatic.Extensions.Http.UnitTests
{
    public class HttpHeadersExtensionsTests
    {
        ...
        [Fact]
        public void Given_a_set_headers_When_Merge_is_called_with_additional_headers_Then_the_headers_should_be_combined_in_the_existing_headers()
        {
            // Arrange & Act
            _sut.Headers.Merge(new Dictionary<string, IEnumerable<string>>
            {
                { "test3", new [] {"value3_1"} },
                { "test4", new [] {"value4_1"} }
            });
        ...
        [Fact]
        public void Given_a_set_headers_When_Merge_is_called_with_no_new_headers_Then_the_headers_should_be_as_is()
        {
            // Arrange & Act
            _sut.Headers.Merge(new Dictionary<string, IEnumerable<string>>());
        ...
        [Fact]
        public void Given_a_set_headers_When_Merge_is_called_with_null_value_Then_the_headers_should_be_as_is()
        {
            // Arrange & Act
            _sut.Headers.Merge(null);
        ...
        [Fact]
        public void Given_a_set_headers_When_Merge_is_called_with_similar_headers_and_different_values_Then_the_headers_should_be_combined_in_the_existing_headers()
        {
            // Arrange & Act
            _sut.Headers.Merge(new Dictionary<string, IEnumerable<string>>
            {
        ...
        [Fact]
        public void Given_a_set_headers_When_Merge_is_called_with_similar_headers_and_similar_values_Then_the_headers_should_be_combined_in_the_existing_headers()
        {
            // Arrange & Act
            _sut.Headers.Merge(new Dictionary<string, IEnumerable<string>>
            {
