...
{
    private sealed class FakeVerifyRequestApiService : VerifyRequestApiService
    {
        public new IClientStub ClientStub => base.ClientStub;

        public FakeVerifyRequestApiService(HttpClient httpClient) : base(httpClient)
        {
    ...
    public void Given_a_VerifyRequestApiService_When_using_SetIdentifierValue_with_IdentifierValue_Then_the_HttpClient_Headers_should_have_the_IdentifierValue()
    {
        ...
        var sut = new FakeVerifyRequestApiService(httpClient);
    ...
    [Fact]
    public async Task Given_a_VerifyRequestApiService_When_using_GetAsync_without_IdentifierHeaderName_Header_and_with_a_ClientStub_Then_should_return_the_registered_ResponseModels()
    {
        // Arrange
        var expected = GetRequestModels();
        var identifierValue = Guid.NewGuid().ToString("N");
    ...
    [Fact]
    public async Task Given_a_VerifyRequestApiService_When_using_RemoveAsync_without_IdentifierHeaderName_Header_Then_return_void()
    {
        // Arrange
        var fakeMessageHandler = new FakeMessageHandler(HttpStatusCode.NoContent, "remove");
        var httpClient = new HttpClient(fakeMessageHandler)
    ...
    [Fact]
    public async Task Given_a_VerifyRequestApiService_When_using_SearchAsync_without_IdentifierHeaderName_Header_and_RequestSearchModel_Then_should_return_RequestModels()
    {
        // Arrange
        var expected = GetRequestModels();
        var identifierValue = Guid.NewGuid().ToString("N");
