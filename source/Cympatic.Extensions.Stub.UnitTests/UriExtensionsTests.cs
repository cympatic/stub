...
public class UriExtensionsTests
{
    ...
    [Fact]
    public void Given_an_absolute_Uri_When_all_queryparams_are_valid_Then_Uri_should_be_formatted_as_expected()
    {
        // Arrange
        var uri = new Uri("https://localhost/baseaddress", UriKind.Absolute);
    ...
    public void Given_an_Uri_When_no_queryparams_Then_exception_should_be_thrown()
    {
        ...
        // Act & Assert
        Assert.Throws<ArgumentNullException>(() => uri.WithParameters(default!));
    }
}
