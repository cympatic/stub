...
namespace Cympatic.Stub.Demo.Api.Services
{
    public class DemoApiService
    {
        ...
        private readonly DemoApiServiceSettings _demoSettings;

        public DemoApiService(HttpClient httpClient, IOptions<DemoApiServiceSettings> options)
        {
        ...
        public async Task<IEnumerable<WeatherForecast>> Get(string stubIdentifierValue)
        {
            ...
            var uri = new Uri(_demoSettings.Url)
